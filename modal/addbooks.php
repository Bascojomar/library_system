  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
                <FORM method="post" action="../backend/addbooks.php" enctype="multipart/form-data">
                ...
                <input type="submit" class="btn btn-primary form-control my-2" name="book">
...
<div class="modal fade" id="books" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">ADD BOOKS</h5>
      ...
      <div class="modal-body">
                ...
                <input type="text" class="form-control my-2" name="author" placeholder="Author">
                <input type="text" class="form-control my-2" name="publisher" placeholder="Publisher">
                <input type="file" class="form-control my-2" name="file" placeholder="File" accept="application/pdf">
                <input type="text" class="form-control my-2" name="category" placeholder="Category">
                <select name="strand" class="form-control my-2">
                ...
                <input type="submit" class="btn btn-primary form-control my-2" name="books">
